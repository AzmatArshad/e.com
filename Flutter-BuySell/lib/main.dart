...
Future<void> main() async {
  ...
  try {
    await Firebase.initializeApp(name:Platform.isIOS? 'com.app.clisbo.es' : 'com.clisbo.app.spain');
...
runApp(EasyLocalization(
      path: 'assets/langs',
      saveLocale: true,
      fallbackLocale: PsConfig.defaultLanguage.toLocale(),
    ...
    return MultiProvider(
        ...
        child: ThemeManager(
            ...
            themedWidgetBuilder: (BuildContext context, ThemeData theme) {
              //set deafault language
              // context.setLocale(PsConfig.defaultLanguage.toLocale());
              return MaterialApp(
                ...
                locale: PsConfig.defaultLanguage.toLocale(),
              );
            }));
  }
